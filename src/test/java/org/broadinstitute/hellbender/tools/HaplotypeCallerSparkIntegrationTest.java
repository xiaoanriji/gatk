...
public class HaplotypeCallerSparkIntegrationTest extends CommandLineProgramTest {
   ...
   */
    ...
    public void testReferenceAdapterIsSerializable() throws IOException {
        final ReferenceMultiSource referenceMultiSource = new ReferenceMultiSource(b37_reference_20_21, ReferenceWindowFunctions.IDENTITY_FUNCTION);
    ...
    public void testReferenceMultiSourceIsSerializable() {
        final ReferenceMultiSource args = new ReferenceMultiSource(GATKBaseTest.b37_reference_20_21, ReferenceWindowFunctions.IDENTITY_FUNCTION);
